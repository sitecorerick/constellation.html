namespace Constellation.Html
{
	...
	public static class RenderBdiExtension
	{
		/// <summary>
		/// Creates a Bdi HTML tag and adds any provided attributes to the tag.
		/// </summary>
		...
		public static HtmlTag RenderBdi(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag("bdi", id, cssClass);
		}
		...
		/// <returns>Div HTML tag with attributes.</returns>
		public static HtmlTag RenderBdi(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, "bdi", attributes);
		}
	}
}
