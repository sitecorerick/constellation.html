namespace Constellation.Html
{
	...
	public static class RenderSmallExtension
	{
		/// <summary>
		/// Creates a small HTML tag and adds any provided attributes to the tag.
		/// </summary>
		...
		public static HtmlTag RenderSmall(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag("small", id, cssClass);
		}
		...
		/// <returns>Span HTML tag with attributes.</returns>
		public static HtmlTag RenderSmall(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, "small", attributes);
		}
	}
}
