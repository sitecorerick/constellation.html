namespace Spark.Html
{
	...
	public static class RenderFigureExtension
	{
		/// <summary>
		...
		/// <returns>Figure HTML tag with attributes.</returns>
		[SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed", Justification = "Welcome to .NET 4.0 FX Cop.")]
		public static HtmlTag RenderFigure(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag("figure", id, cssClass);
		}
		...
		public static HtmlTag RenderFigure(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, "figure", attributes);
		}
	}
}