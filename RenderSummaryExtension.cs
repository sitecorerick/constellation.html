namespace Constellation.Html
{
	...
	public static class RenderSummaryExtension
	{
		/// <summary>
		/// Creates a summary HTML tag and adds any provided attributes to the tag.
		/// </summary>
		...
		public static HtmlTag RenderSummary(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag("summary", id, cssClass);
		}
		...
		/// <returns>Span HTML tag with attributes.</returns>
		public static HtmlTag RenderSummary(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, "summary", attributes);
		}
	}
}
