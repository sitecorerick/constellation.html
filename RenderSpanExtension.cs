namespace Constellation.Html
{
	...
	public static class RenderSpanExtension
	{
		/// <summary>
		/// Creates a Span HTML tag and adds any provided attributes to the tag.
		/// </summary>
		...
		public static HtmlTag RenderSpan(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return RenderTagExtension.RenderTag(writer, HtmlTextWriterTag.Span, id, cssClass);
		}
		...
		/// <returns>Span HTML tag with attributes.</returns>
		public static HtmlTag RenderSpan(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, HtmlTextWriterTag.Span, attributes);
		}
	}
}
