namespace Constellation.Html
{
	...
	public static class RenderLiExtension
	{
		/// <summary>
		/// Creates a Li HTML tag and adds any provided attributes to the tag.
		/// </summary>
		/// <param name="writer">The HTMLTextWriter.</param>
		/// <param name="id">The value of the id attribute.</param>
		/// <param name="cssClass">The value of the class attribute.</param>
		/// <returns>Li HTML tag with attributes.</returns>
		[SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed", Justification = "Welcome to .NET 4.0 FX Cop.")]
		public static HtmlTag RenderLi(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return RenderTagExtension.RenderTag(writer, HtmlTextWriterTag.Li, id, cssClass);
		}
		...
		/// <returns>Li HTML tag with attributes.</returns>
		public static HtmlTag RenderLi(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, HtmlTextWriterTag.Li, attributes);
		}
	}
}
