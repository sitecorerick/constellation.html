namespace Spark.Html
{
	...
	public static class RenderDivExtension
	{
		/// <summary>
		...
		public static HtmlTag RenderDiv(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag(HtmlTextWriterTag.Div, id, cssClass);
		}
		...
		/// <returns>Div HTML tag with attributes.</returns>
		public static HtmlTag RenderDiv(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, HtmlTextWriterTag.Div, attributes);
		}
	}
}
