namespace Spark.Html
{
	...
	public static class RenderH5Extension
	{
		/// <summary>
		...
		public static HtmlTag RenderH5(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return RenderTagExtension.RenderTag(writer, HtmlTextWriterTag.H5, id, cssClass);
		}
