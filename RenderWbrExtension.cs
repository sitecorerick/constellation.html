namespace Constellation.Html
{
	...
	public static class RenderWbrExtension
	{
		/// <summary>
		/// Creates a wbr HTML tag and adds any provided attributes to the tag.
		/// </summary>
		...
		public static HtmlTag RenderWbr(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag("wbr", id, cssClass);
		}
		...
		/// <returns>Span HTML tag with attributes.</returns>
		public static HtmlTag RenderWbr(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, "wbr", attributes);
		}
	}
}
