namespace Constellation.Html
{
	...
	public static class RenderArticleExtension
	{
		/// <summary>
		/// Creates an  Article HTML tag and adds any provided attributes to the tag.
		/// </summary>
		...
		public static HtmlTag RenderArticle(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag("article", id, cssClass);
		}
		...
		/// <returns>Div HTML tag with attributes.</returns>
		public static HtmlTag RenderArticle(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, "article", attributes);
		}
	}
}
