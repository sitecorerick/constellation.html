namespace Constellation.Html
{
	...
	public static class RenderMarkExtension
	{
		/// <summary>
		/// Creates a Mark HTML tag and adds any provided attributes to the tag.
		/// </summary>
		...
		public static HtmlTag RenderMark(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag("mark", id, cssClass);
		}
		...
		/// <returns>Div HTML tag with attributes.</returns>
		public static HtmlTag RenderMark(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, "mark", attributes);
		}
	}
}
