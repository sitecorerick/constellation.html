namespace Constellation.Html
{
	...
	public static class RenderHeaderExtension
	{
		/// <summary>
		/// Creates a Header HTML tag and adds any provided attributes to the tag.
		/// </summary>
		...
		public static HtmlTag RenderHeader(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag("header", id, cssClass);
		}
		...
		/// <returns>Div HTML tag with attributes.</returns>
		public static HtmlTag RenderHeader(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, "header", attributes);
		}
	}
}
