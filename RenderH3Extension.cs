namespace Constellation.Html
{
	...
	public static class RenderH3Extension
	{
		/// <summary>
		/// Creates a H3 HTML tag and adds any provided attributes to the tag.
		/// </summary>
		/// <param name="writer">The HTMLTextWriter.</param>
		/// <param name="id">The value of the id attribute.</param>
		/// <param name="cssClass">The value of the class attribute.</param>
		/// <returns>H3 HTML tag with attributes.</returns>
		[SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed", Justification = "Welcome to .NET 4.0 FX Cop.")]
		public static HtmlTag RenderH3(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return RenderTagExtension.RenderTag(writer, HtmlTextWriterTag.H3, id, cssClass);
		}
		...
		/// <returns>H3 HTML tag with attributes.</returns>
		public static HtmlTag RenderH3(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, HtmlTextWriterTag.H3, attributes);
		}
	}
}
