namespace Constellation.Html
{
	...
	public static class RenderFooterExtension
	{
		/// <summary>
		/// Creates a Footer HTML tag and adds any provided attributes to the tag.
		/// </summary>
		...
		public static HtmlTag RenderFooter(this HtmlTextWriter writer, string id = null, string cssClass = null)
		{
			return writer.RenderTag("footer", id, cssClass);
		}
		...
		/// <returns>Div HTML tag with attributes.</returns>
		public static HtmlTag RenderFooter(this HtmlTextWriter writer, params HtmlAttribute[] attributes)
		{
			return new HtmlTag(writer, "footer", attributes);
		}
	}
}
